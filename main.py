...
app = FastAPI(title="Anime API", version="0.1", docs_url="/docs")
...
@app.delete("/animes/{id_anime}", description="Sprovodíme anime ze světa", responses={
    404: {'model': Problem}
})
...
@app.patch("/animes/{id_anime}", description="Aktualizujeme film do DB", responses={
    404: {'model': Problem}
})
